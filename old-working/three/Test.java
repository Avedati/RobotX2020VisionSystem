...
public class Test {
	...
	public static boolean anglesTest(MatOfPoint polygon) {
		...
		for(int i=0;i<polygon.toList().size();i++) {
			...
			if(cosTheta < Math.cos(20 * Math.PI / 180)) { numPassed++; }
		}
		return numPassed >= 6;
	}
